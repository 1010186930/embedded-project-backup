...
int main(void)
{
	...
	u8 key_v;
	u8 res;    
	u8 buf[121]="111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111000000000000";
...
//  	USBH_Init(&USB_OTG_Core,USB_OTG_FS_CORE_ID,&USB_Host,&USBH_MSC_cb,&USR_cb); 
	...
	while(1)
	{
		Braille_Display(buf,120,InputToIO);
//		for(i=1;i<=15;i++)
//		{
//			Cell_Control(i);
//			delay_ms(1500);
