...
__align(32) u8 mem2base[MEM2_MAX_SIZE] __attribute__((at(0XC01F4000+0x1000)));					//外部SDRAM内存池,前面2M给LTDC用了(1280*800*2)
...
u32 mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((at(0XC01F4000+0x1000+MEM2_MAX_SIZE)));	//外部SRAM内存池MAP
